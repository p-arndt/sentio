...
import { Calendar, Ghost, Globe, Palette, Users } from '@lucide/svelte';
		...
		fields: [
			{
				...
				defaultValue: 'public',
				options: [
					{ value: 'public', label: 'Share publicly', icon: Globe },
					{ value: 'anonymous', label: 'Share anonymously', icon: Ghost }
				]
			}
		]
	}
